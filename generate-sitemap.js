...
const routes = [
  ...
  { path: '/blends/formula-m51', priority: '0.7', changefreq: 'monthly' },
  { path: '/blends/formula-n5550', priority: '0.7', changefreq: 'monthly' },
  { path: '/blends/formula-rg5555', priority: '0.7', changefreq: 'monthly' },
