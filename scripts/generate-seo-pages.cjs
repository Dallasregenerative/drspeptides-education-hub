...
const ROUTE_META = {
  ...
  "/news": { title: "Peptide Industry News - Latest Regulatory Updates, Market Trends & Clinical Developments", desc: "Stay informed with the latest peptide therapy news. FDA regulatory updates, market trends, clinical trial results, and industry developments for healthcare practitioners.", type: "page" },
  "/training-partner": { title: "Hands-On Peptide & Regenerative Training | 1228 Wellness", desc: "Comprehensive hands-on training in peptide therapy, regenerative aesthetics, PRP/PRF, and practice building. 700+ providers trained, 350+ practices launched. From education to practice ownership.", type: "page" },
  ...
  "/walkthrough": { title: "Book a 15-Minute Platform Walkthrough | Peptide Education Hub", desc: "Schedule a 15-minute walkthrough of Dr. Peptide and the contributing-practitioner program. See the AI live, ask clinical questions, and learn how to get lifetime free access.", type: "page" },
  ...
  // Additional peptide pages (previously missing from SEO generation)
  "/peptides/adipotide": { title: "Adipotide - Fat Cell Targeting Peptide", desc: "Comprehensive adipotide guide: PROHIBITIN-targeting mechanism, adipose tissue apoptosis, weight loss applications, and clinical research.", type: "peptide", category: "Weight Loss" },
  "/peptides/alpha-gpc": { title: "Alpha-GPC - Choline Supplement", desc: "Comprehensive Alpha-GPC guide: choline precursor mechanism, cognitive enhancement dosing, acetylcholine support, and clinical applications.", type: "peptide", category: "Cognitive Enhancement" },
  "/peptides/cortexin": { title: "Cortexin - Neuroprotective Peptide Complex", desc: "Comprehensive cortexin guide: brain-derived peptide complex mechanism, neuroprotection dosing, cognitive recovery, and clinical protocols.", type: "peptide", category: "Cognitive Enhancement" },
  "/peptides/fisetin": { title: "Fisetin - Senolytic Flavonoid", desc: "Comprehensive fisetin guide: senolytic flavonoid mechanism, anti-aging dosing, cellular rejuvenation, and clinical research.", type: "peptide", category: "Anti-Aging" },
  "/peptides/gdf-11": { title: "GDF-11 - Growth Differentiation Factor", desc: "Comprehensive GDF-11 guide: rejuvenation factor mechanism, anti-aging dosing, tissue regeneration, and clinical applications.", type: "peptide", category: "Anti-Aging" },
  "/peptides/nac": { title: "NAC - N-Acetyl Cysteine", desc: "Comprehensive NAC guide: glutathione precursor mechanism, antioxidant dosing, respiratory health, and clinical applications.", type: "peptide", category: "Immune" },
  "/peptides/nmn": { title: "NMN - Nicotinamide Mononucleotide", desc: "Comprehensive NMN guide: NAD+ precursor mechanism, anti-aging dosing, cellular energy optimization, and clinical research.", type: "peptide", category: "Anti-Aging" },
  "/peptides/noopept": { title: "Noopept - Cognitive Enhancement Peptide", desc: "Comprehensive noopept guide: neuropeptide mechanism, cognitive enhancement dosing, memory improvement, and clinical applications.", type: "peptide", category: "Cognitive Enhancement" },
  "/peptides/pterostilbene": { title: "Pterostilbene - Bioavailable Resveratrol Analog", desc: "Comprehensive pterostilbene guide: enhanced resveratrol analog mechanism, anti-aging dosing, sirtuin activation, and clinical research.", type: "peptide", category: "Anti-Aging" },
  "/peptides/quercetin": { title: "Quercetin - Senolytic Flavonoid", desc: "Comprehensive quercetin guide: senolytic flavonoid mechanism, anti-aging dosing, immune support, and clinical applications.", type: "peptide", category: "Anti-Aging" },
