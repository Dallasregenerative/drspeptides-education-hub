...
const ROUTE_META = {
  ...
  "/dr-peptide/watch": { title: "Meet Dr. Peptide — Watch the 75-Second Introduction | PepEdHub.com", desc: "Watch the 75-second introduction to Dr. Peptide, the AI built on PepEdHub.com — a deeply researched, evidence-based peptide knowledge base used by a growing community of practitioners.", type: "page" },
