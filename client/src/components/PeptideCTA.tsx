...
import { Bot, Brain, BookOpen, ArrowRight } from "lucide-react";
      ...
      <CardContent className="p-8">
        <div className="text-center">
          ...
          <p className="text-slate-600 dark:text-slate-400 mb-6 max-w-2xl mx-auto">
            Dr. Peptide AI generates evidence-based protocols using 16 specialized AI agents 
            trained on 2,800+ clinical studies.
          </p>
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400 mt-4">
            Powered by PeptideProtocols.ai — Evidence-based protocol generation
          </p>
        </div>
      </CardContent>
    </Card>
