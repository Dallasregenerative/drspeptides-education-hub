...
export default function BlendFormulaN259() {
  usePageTitle("Formula N-259: Sleep & Circadian Optimization", {
    ...
    schema: [
    {
      ...
      "activeIngredient": "50 mg Apigenin + 300 mg Magnesium Glycinate + 200 mg L-Theanine + 500 mcg Melatonin",
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <Card className="bg-gradient-to-r from-teal-600 to-cyan-600 text-white">
          <CardContent className="py-8 text-center">
            <h3 className="text-2xl font-bold mb-4">Get a Personalized Formula N-259 Protocol</h3>
