                    ...
                    <table className="min-w-full divide-y divide-slate-200 dark:divide-slate-700">
                      <thead className="bg-slate-50 dark:bg-slate-700">
                        <tr>
                          ...
                          <th className="px-4 py-3 text-left text-xs font-medium text-slate-700 dark:text-slate-300 uppercase tracking-wider">2026 RVU</th>
                        </tr>
                      </thead>
            ...
            <div className="bg-white dark:bg-slate-800 rounded-lg shadow-md p-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-lg p-6 border border-blue-200 dark:border-blue-800">
                  ...
                  <button onClick={() => { const html = '<html><head><title>Letter of Medical Necessity Template</title><style>body{font-family:Segoe UI,sans-serif;max-width:8.5in;margin:0 auto;padding:0.5in;line-height:1.6;font-size:11pt}h1{color:#2563eb;border-bottom:2px solid #2563eb;padding-bottom:8px}h2{color:#1e40af;margin-top:20px}.field{background:#f0f4ff;padding:8px 12px;border-radius:4px;margin:4px 0;border-left:3px solid #2563eb}.note{background:#fef3c7;padding:10px;border-radius:4px;font-size:10pt;margin-top:15px}@media print{body{padding:0}@page{margin:0.75in}}</style></head><body><h1>Letter of Medical Necessity</h1><p><strong>Date:</strong> <span class="field">[Date]</span></p><p><strong>To:</strong> <span class="field">[Insurance Company / Medical Director]</span></p><p><strong>Re: Patient:</strong> <span class="field">[Patient Name, DOB]</span></p><p><strong>Policy #:</strong> <span class="field">[Policy Number]</span></p><h2>Diagnosis</h2><p class="field">[Primary diagnosis with ICD-10 code, e.g., E66.01 - Morbid obesity due to excess calories]</p><h2>Clinical History</h2><p class="field">[Document BMI, comorbidities, duration of condition, previous treatments attempted and failed]</p><h2>Requested Treatment</h2><p class="field">[Specific peptide therapy, dose, frequency, expected duration]</p><h2>Medical Necessity Justification</h2><p class="field">[Clinical evidence supporting treatment, FDA approval status, clinical trial data, expected outcomes]</p><h2>Failed Conservative Treatments</h2><ul><li class="field">[Treatment 1 - dates, duration, outcome]</li><li class="field">[Treatment 2 - dates, duration, outcome]</li></ul><h2>Expected Outcomes</h2><p class="field">[Specific measurable outcomes expected with treatment]</p><p style="margin-top:30px"><strong>Sincerely,</strong></p><p class="field">[Provider Name, Credentials]<br/>[Practice Name]<br/>[NPI Number]<br/>[Contact Information]</p><div class="note"><strong>Note:</strong> This is a template. Customize all bracketed fields with patient-specific information. Generated by Peptide Education Hub.</div></body></html>'; const blob = new Blob([html], { type: 'text/html' }); const url = URL.createObjectURL(blob); const a = document.createElement('a'); a.href = url; a.download = 'template.html'; document.body.appendChild(a); a.click(); document.body.removeChild(a); setTimeout(() => URL.revokeObjectURL(url), 5000); }} className="w-full bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors flex items-center justify-center gap-2">
                ...
                <div className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-lg p-6 border border-purple-200 dark:border-purple-800">
                  ...
                  <button onClick={() => { const html = '<html><head><title>Prior Authorization Request Form</title><style>body{font-family:Segoe UI,sans-serif;max-width:8.5in;margin:0 auto;padding:0.5in;line-height:1.6;font-size:11pt}h1{color:#9333ea;border-bottom:2px solid #9333ea;padding-bottom:8px}h2{color:#7e22ce;margin-top:20px}.field{background:#faf5ff;padding:8px 12px;border-radius:4px;margin:4px 0;border-left:3px solid #9333ea}table{width:100%;border-collapse:collapse;margin:10px 0}th,td{border:1px solid #d8b4fe;padding:6px 10px;text-align:left;font-size:10pt}th{background:#f3e8ff}.note{background:#fef3c7;padding:10px;border-radius:4px;font-size:10pt;margin-top:15px}@media print{body{padding:0}@page{margin:0.75in}}</style></head><body><h1>Prior Authorization Request Form</h1><h2>Patient Information</h2><table><tr><td><strong>Patient Name:</strong></td><td class="field">[Name]</td><td><strong>DOB:</strong></td><td class="field">[DOB]</td></tr><tr><td><strong>Member ID:</strong></td><td class="field">[ID]</td><td><strong>Group #:</strong></td><td class="field">[Group]</td></tr></table><h2>Prescriber Information</h2><table><tr><td><strong>Provider:</strong></td><td class="field">[Name, Credentials]</td><td><strong>NPI:</strong></td><td class="field">[NPI]</td></tr><tr><td><strong>Practice:</strong></td><td class="field">[Practice Name]</td><td><strong>Phone:</strong></td><td class="field">[Phone]</td></tr></table><h2>Medication Requested</h2><table><tr><th>Medication</th><th>Dose</th><th>Frequency</th><th>Duration</th></tr><tr><td class="field">[Peptide name]</td><td class="field">[Dose]</td><td class="field">[Frequency]</td><td class="field">[Duration]</td></tr></table><h2>Clinical Justification</h2><p class="field">[Diagnosis, ICD-10 codes, clinical rationale]</p><h2>Supporting Documentation Checklist</h2><ul><li>☐ Recent lab results</li><li>☐ Office visit notes</li><li>☐ Previous treatment history</li><li>☐ Letter of medical necessity</li><li>☐ Relevant clinical studies</li></ul><div class="note"><strong>Note:</strong> Template for educational purposes. Generated by Peptide Education Hub.</div></body></html>'; const blob = new Blob([html], { type: 'text/html' }); const url = URL.createObjectURL(blob); const a = document.createElement('a'); a.href = url; a.download = 'template.html'; document.body.appendChild(a); a.click(); document.body.removeChild(a); setTimeout(() => URL.revokeObjectURL(url), 5000); }} className="w-full bg-purple-600 text-white px-4 py-2 rounded-lg hover:bg-purple-700 transition-colors flex items-center justify-center gap-2">
                    <Download className="h-4 w-4" />
                    Download Template
                  </button>
                </div>
                ...
                <div className="bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 rounded-lg p-6 border border-emerald-200 dark:border-emerald-800">
                  ...
                  <button onClick={() => { const html = '<html><head><title>Insurance Appeal Letter Template</title><style>body{font-family:Segoe UI,sans-serif;max-width:8.5in;margin:0 auto;padding:0.5in;line-height:1.6;font-size:11pt}h1{color:#059669;border-bottom:2px solid #059669;padding-bottom:8px}h2{color:#047857;margin-top:20px}.field{background:#ecfdf5;padding:8px 12px;border-radius:4px;margin:4px 0;border-left:3px solid #059669}.note{background:#fef3c7;padding:10px;border-radius:4px;font-size:10pt;margin-top:15px}@media print{body{padding:0}@page{margin:0.75in}}</style></head><body><h1>Insurance Appeal Letter</h1><p><strong>Date:</strong> <span class="field">[Date]</span></p><p><strong>To:</strong> <span class="field">[Insurance Company Appeals Department]</span></p><p><strong>Re:</strong> Appeal of Denial - <span class="field">[Claim/Reference Number]</span></p><p><strong>Patient:</strong> <span class="field">[Patient Name, DOB, Member ID]</span></p><h2>Summary of Denial</h2><p class="field">[Date of denial, reason given, specific medication/treatment denied]</p><h2>Basis for Appeal</h2><p class="field">[Explain why the denial should be overturned, citing medical necessity, clinical evidence, and patient-specific factors]</p><h2>Clinical Evidence</h2><ul><li class="field">[NEJM Study - Semaglutide 2.4mg: 14.9% mean weight loss (PMID: 33567185)]</li><li class="field">[Additional relevant clinical trials and outcomes data]</li></ul><h2>Cost-Effectiveness Argument</h2><p class="field">[Compare treatment cost vs. cost of untreated comorbidities, hospitalizations, etc.]</p><h2>Requested Action</h2><p class="field">[Specific request - approve coverage, reconsider denial, etc.]</p><p style="margin-top:30px"><strong>Sincerely,</strong></p><p class="field">[Provider Name, Credentials]<br/>[Practice Name]<br/>[NPI Number]</p><div class="note"><strong>Note:</strong> Template for educational purposes. Generated by Peptide Education Hub.</div></body></html>'; const blob = new Blob([html], { type: 'text/html' }); const url = URL.createObjectURL(blob); const a = document.createElement('a'); a.href = url; a.download = 'template.html'; document.body.appendChild(a); a.click(); document.body.removeChild(a); setTimeout(() => URL.revokeObjectURL(url), 5000); }} className="w-full bg-emerald-600 text-white px-4 py-2 rounded-lg hover:bg-emerald-700 transition-colors flex items-center justify-center gap-2">
                    <Download className="h-4 w-4" />
                    Download Template
                  </button>
                </div>
                ...
                <div className="bg-gradient-to-br from-orange-50 to-red-50 dark:from-orange-900/20 dark:to-red-900/20 rounded-lg p-6 border border-orange-200 dark:border-orange-800">
                  ...
                  <button onClick={() => { const html = '<html><head><title>Superbill Template</title><style>body{font-family:Segoe UI,sans-serif;max-width:8.5in;margin:0 auto;padding:0.5in;line-height:1.5;font-size:10pt}h1{color:#ea580c;border-bottom:2px solid #ea580c;padding-bottom:8px;font-size:18pt}h2{color:#c2410c;margin-top:15px;font-size:13pt}table{width:100%;border-collapse:collapse;margin:8px 0}th,td{border:1px solid #fed7aa;padding:5px 8px;text-align:left}th{background:#fff7ed;font-weight:600}.field{background:#fff7ed;padding:6px 10px;border-radius:4px;border-left:3px solid #ea580c}.note{background:#fef3c7;padding:10px;border-radius:4px;font-size:9pt;margin-top:15px}@media print{body{padding:0}@page{margin:0.6in}}</style></head><body><h1>Superbill / Patient Receipt</h1><table><tr><td><strong>Practice:</strong> <span class="field">[Practice Name]</span></td><td><strong>NPI:</strong> <span class="field">[NPI]</span></td></tr><tr><td><strong>Provider:</strong> <span class="field">[Provider Name]</span></td><td><strong>Tax ID:</strong> <span class="field">[Tax ID]</span></td></tr><tr><td><strong>Address:</strong> <span class="field">[Address]</span></td><td><strong>Phone:</strong> <span class="field">[Phone]</span></td></tr></table><table><tr><td><strong>Patient:</strong> <span class="field">[Name]</span></td><td><strong>DOB:</strong> <span class="field">[DOB]</span></td><td><strong>Date:</strong> <span class="field">[Visit Date]</span></td></tr></table><h2>Diagnosis Codes (ICD-10)</h2><table><tr><th>Code</th><th>Description</th></tr><tr><td>E66.01</td><td>Morbid obesity due to excess calories</td></tr><tr><td>E66.09</td><td>Other obesity due to excess calories</td></tr><tr><td>E11.65</td><td>Type 2 diabetes with hyperglycemia</td></tr><tr><td>E78.5</td><td>Dyslipidemia, unspecified</td></tr></table><h2>CPT Codes</h2><table><tr><th>Code</th><th>Description</th><th>Fee</th></tr><tr><td>99213</td><td>Office visit, established patient (low complexity)</td><td class="field">[Fee]</td></tr><tr><td>99214</td><td>Office visit, established patient (moderate complexity)</td><td class="field">[Fee]</td></tr><tr><td>96372</td><td>Therapeutic injection, subcutaneous</td><td class="field">[Fee]</td></tr><tr><td>J3490</td><td>Unclassified drugs (peptide therapy)</td><td class="field">[Fee]</td></tr></table><p><strong>Total:</strong> <span class="field">[Total Amount]</span></p><div class="note"><strong>Note:</strong> Template for educational purposes. Generated by Peptide Education Hub.</div></body></html>'; const blob = new Blob([html], { type: 'text/html' }); const url = URL.createObjectURL(blob); const a = document.createElement('a'); a.href = url; a.download = 'template.html'; document.body.appendChild(a); a.click(); document.body.removeChild(a); setTimeout(() => URL.revokeObjectURL(url), 5000); }} className="w-full bg-orange-600 text-white px-4 py-2 rounded-lg hover:bg-orange-700 transition-colors flex items-center justify-center gap-2">
                    <Download className="h-4 w-4" />
                    Download Template
                  </button>
                </div>
                ...
                <div className="bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-700/50 dark:to-slate-800/50 rounded-lg p-6 border border-slate-200 dark:border-slate-700">
                  ...
                  <button onClick={() => { const html = '<html><head><title>Financial Policy Template</title><style>body{font-family:Segoe UI,sans-serif;max-width:8.5in;margin:0 auto;padding:0.5in;line-height:1.6;font-size:11pt}h1{color:#475569;border-bottom:2px solid #475569;padding-bottom:8px}h2{color:#334155;margin-top:20px}.field{background:#f8fafc;padding:8px 12px;border-radius:4px;margin:4px 0;border-left:3px solid #475569}.note{background:#fef3c7;padding:10px;border-radius:4px;font-size:10pt;margin-top:15px}@media print{body{padding:0}@page{margin:0.75in}}</style></head><body><h1>Financial Policy - Peptide Therapy Program</h1><p class="field">[Practice Name]</p><h2>Payment Policy</h2><p>Payment is due at the time of service. We accept cash, credit cards, HSA/FSA cards, and approved financing options.</p><h2>Insurance Coverage</h2><p>Some peptide therapies may be covered by insurance. We will verify benefits and obtain prior authorization when applicable. Patients are responsible for any copays, deductibles, or non-covered services.</p><h2>Self-Pay Pricing</h2><p>For patients without insurance coverage or who prefer self-pay, we offer transparent pricing and package discounts.</p><h2>Cancellation Policy</h2><p>Please provide at least 24 hours notice for appointment cancellations. Late cancellations or no-shows may be subject to a fee.</p><h2>Refund Policy</h2><p>Medications that have been dispensed cannot be returned. Unused prepaid services may be refunded minus a processing fee.</p><p style="margin-top:30px"><strong>Patient Signature:</strong> _________________________ <strong>Date:</strong> _____________</p><div class="note"><strong>Note:</strong> Template for educational purposes. Customize for your practice. Generated by Peptide Education Hub.</div></body></html>'; const blob = new Blob([html], { type: 'text/html' }); const url = URL.createObjectURL(blob); const a = document.createElement('a'); a.href = url; a.download = 'template.html'; document.body.appendChild(a); a.click(); document.body.removeChild(a); setTimeout(() => URL.revokeObjectURL(url), 5000); }} className="w-full bg-slate-600 text-white px-4 py-2 rounded-lg hover:bg-slate-700 transition-colors flex items-center justify-center gap-2">
                    <Download className="h-4 w-4" />
                    Download Template
                  </button>
                </div>
                ...
                <div className="bg-gradient-to-br from-yellow-50 to-amber-50 dark:from-yellow-900/20 dark:to-amber-900/20 rounded-lg p-6 border border-yellow-200 dark:border-yellow-800">
                  ...
                  <button onClick={() => { const html = '<html><head><title>Cost Estimate Worksheet</title><style>body{font-family:Segoe UI,sans-serif;max-width:8.5in;margin:0 auto;padding:0.5in;line-height:1.5;font-size:11pt}h1{color:#ca8a04;border-bottom:2px solid #ca8a04;padding-bottom:8px}h2{color:#a16207;margin-top:18px}table{width:100%;border-collapse:collapse;margin:10px 0}th,td{border:1px solid #fde68a;padding:6px 10px;text-align:left;font-size:10pt}th{background:#fefce8;font-weight:600}.field{background:#fefce8;padding:6px 10px;border-radius:4px;border-left:3px solid #ca8a04}.total{font-weight:bold;font-size:12pt;background:#fef9c3}.note{background:#fef3c7;padding:10px;border-radius:4px;font-size:10pt;margin-top:15px}@media print{body{padding:0}@page{margin:0.75in}}</style></head><body><h1>Patient Cost Estimate Worksheet</h1><table><tr><td><strong>Patient:</strong> <span class="field">[Name]</span></td><td><strong>Date:</strong> <span class="field">[Date]</span></td></tr><tr><td><strong>Program:</strong> <span class="field">[Treatment Program]</span></td><td><strong>Duration:</strong> <span class="field">[Weeks/Months]</span></td></tr></table><h2>Medication Costs</h2><table><tr><th>Medication</th><th>Dose</th><th>Supply</th><th>Cost</th></tr><tr><td class="field">[Peptide 1]</td><td class="field">[Dose]</td><td class="field">[30 days]</td><td class="field">$[Amount]</td></tr><tr><td class="field">[Peptide 2]</td><td class="field">[Dose]</td><td class="field">[30 days]</td><td class="field">$[Amount]</td></tr></table><h2>Visit Costs</h2><table><tr><th>Service</th><th>Frequency</th><th>Per Visit</th><th>Total</th></tr><tr><td>Initial Consultation</td><td>1x</td><td class="field">$[Amount]</td><td class="field">$[Amount]</td></tr><tr><td>Follow-up Visits</td><td class="field">[#] visits</td><td class="field">$[Amount]</td><td class="field">$[Amount]</td></tr><tr><td>Lab Work</td><td class="field">[#] panels</td><td class="field">$[Amount]</td><td class="field">$[Amount]</td></tr></table><h2>Program Total</h2><table><tr class="total"><td colspan="3">Estimated Total Cost</td><td class="field">$[Total]</td></tr></table><div class="note"><strong>Note:</strong> Costs are estimates and may vary. Generated by Peptide Education Hub.</div></body></html>'; const blob = new Blob([html], { type: 'text/html' }); const url = URL.createObjectURL(blob); const a = document.createElement('a'); a.href = url; a.download = 'template.html'; document.body.appendChild(a); a.click(); document.body.removeChild(a); setTimeout(() => URL.revokeObjectURL(url), 5000); }} className="w-full bg-yellow-600 text-white px-4 py-2 rounded-lg hover:bg-yellow-700 transition-colors flex items-center justify-center gap-2">
                    <Download className="h-4 w-4" />
                    Download Template
                  </button>
                </div>
