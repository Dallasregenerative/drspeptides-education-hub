...
export default function PeptideDSIP() {
  usePageTitle("DSIP - Delta Sleep-Inducing Peptide", {
    description: "Comprehensive guide to DSIP (Delta Sleep-Inducing Peptide) for sleep optimization. Mechanisms, clinical applications, dosing protocols, and safety data."
  });
      ...
      <header className="border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 sticky top-0 z-50">
        <div className="container flex h-16 items-center justify-between">
          ...
          <Link href="/">
            ...
            <PrintButton title="D S I P - Patient Information" subtitle="Peptide Education Hub" className="ml-2" />
        </div>
      </header>
