...
import { Brain, Clock, Zap, Sparkles, AlertTriangle, CheckCircle, Shield, ArrowLeft} from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <Card className="bg-gradient-to-r from-teal-600 to-cyan-600 text-white">
          <CardContent className="py-8 text-center">
            <h3 className="text-2xl font-bold mb-4">Get a Personalized Formula N-111 Protocol</h3>
