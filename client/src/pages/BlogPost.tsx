...
const blogPostMapping: Record<string, { file: string; title: string; description?: string }> = {
  ...
  // New SEO-targeted blog posts - July 2026 (Patient Education & Comparisons)
  "semaglutide-vs-tirzepatide": { file: "SemaglutideVsTirzepatide.md", title: "Semaglutide vs Tirzepatide: Which Weight Loss Peptide is Better?", description: "Compare Semaglutide and Tirzepatide for weight loss - mechanism, efficacy, and side effects." },
  "bpc-157-vs-tb-500": { file: "BPC157vsTB500.md", title: "BPC-157 vs TB-500: Which Healing Peptide is Right for You?", description: "Compare BPC-157 and TB-500 for injury recovery, tissue healing, and inflammation." },
  "peptide-therapy-cost-guide": { file: "PeptideTherapyCostGuide.md", title: "How Much Does Peptide Therapy Cost in 2026? A Complete Pricing Guide", description: "The true cost of peptide therapy in 2026 including clinic fees and pharmacy costs." },
  "is-peptide-therapy-fda-approved": { file: "IsPeptideTherapyFDAApproved.md", title: "Is Peptide Therapy FDA Approved? What Patients and Providers Need to Know", description: "Understanding the regulatory landscape of peptide therapy and what off-label use means." },
  "how-long-does-peptide-therapy-take-to-work": { file: "HowLongDoesPeptideTherapyTakeToWork.md", title: "How Long Does Peptide Therapy Take to Work? A Timeline of Results", description: "A comprehensive timeline of what to expect when starting peptide therapy." },
  "are-peptides-safe": { file: "ArePeptidesSafe.md", title: "Are Peptides Safe? Understanding the Risks and Benefits", description: "An objective look at the safety profile of peptide therapy and how to minimize risks." },
