        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <div className="bg-white dark:bg-slate-900 rounded-lg p-6 shadow-lg">
              <img src="/pepedhub_infographic_bpc157.webp" alt="BPC-157 Benefits Infographic" className="w-full rounded-lg mb-4" />
            ...
            <div className="bg-white dark:bg-slate-900 rounded-lg p-6 shadow-lg">
              <img src="/pepedhub_comparison_chart.webp" alt="Peptide Category Comparison" className="w-full rounded-lg mb-4" />
