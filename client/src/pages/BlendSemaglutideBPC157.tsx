  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-secondary/20">
          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-xl text-muted-foreground max-w-3xl">
                Dual-action blend combining GLP-1 receptor agonism for metabolic regulation with tissue repair mechanisms for comprehensive weight management and gastrointestinal health support.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="container py-12">
        <div className="grid md:grid-d-cols-3 gap-8 mb-12">
          {/* Composition */}
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="p-4 bg-secondary/50 rounded-lg">
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>• Semaglutide: <span className="font-semibold">5mg</span></li>
                      <li>• BPC-157: <span className="font-semibold">0.65mg</span></li>
                    </ul>
                  </div>
                  <div className="p-4 bg-secondary/50 rounded-lg">
                    <p className="font-semibold text-primary mb-2">High Strength</p>
                    <ul className="space-y-1 text-sm">
                      <li>• Semaglutide: <span className="font-semibold">30mg</span></li>
                      <li>• BPC-157: <span className="font-semibold">3.5mg</span></li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="font-semibold mb-1">Semaglutide (GLP-1 Agonist)</p>
                      <p className="text-sm text-muted-foreground">
                        Reduces appetite, slows gastric emptying, improves glycemic control, and promotes significant weight loss through central and peripheral mechanisms.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="font-semibold mb-1">BPC-157 (Tissue Repair)</p>
                      <p className="text-sm text-muted-foreground">
                        Promotes gastrointestinal integrity, supports tissue healing, modulates inflammation, and may protect against GLP-1-related GI side effects.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="font-semibold mb-1">Complementary Benefits</p>
                      <p className="text-sm text-muted-foreground">
                        BPC-157's gastroprotective properties may mitigate nausea and GI discomfort commonly associated with GLP-1 agonists, while semaglutide provides metabolic optimization.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="pt-4 border-t">
                <a 
                  href="https://drspeptides.com/products/semaglutide-bpc-157" 
                  target="_blank" 
        ...
        <Card className="mb-12">
          ...
          <CardContent>
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h3 className="font-semibold mb-3">Weight Management Studies</h3>
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li>• Semaglutide clinical trials demonstrate up to 15-20% body weight reduction</li>
                  <li>• GLP-1 receptor activation reduces appetite and food intake</li>
                  <li>• Improved glycemic control in metabolic syndrome</li>
                  <li>• Cardiovascular risk reduction in obesity</li>
                </ul>
              </div>
              <div>
                <h3 className="font-semibold mb-3">Gastrointestinal Protection</h3>
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li>• BPC-157 promotes mucosal healing and barrier integrity</li>
                  <li>• May reduce GLP-1-associated nausea and GI discomfort</li>
                  <li>• Supports tissue repair during metabolic transition</li>
                  <li>• Anti-inflammatory effects in GI tract</li>
                </ul>
              </div>
            </div>
          </CardContent>
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <ul className="text-sm text-muted-foreground space-y-1">
                ...
                <li>• Gradual dose titration recommended to minimize GI side effects</li>
          ...
          <Card className="inline-block">
            <CardContent className="pt-6">
              ...
              <p className="text-muted-foreground mb-4 max-w-xl">
                DrsPeptides.com provides research-grade Semaglutide/BPC-157 blend with verified purity and composition for qualified healthcare providers.
              </p>
