...
"ai-formula-design": { title: "AI-Driven Formula Design: The Future of Peptide Blends", desc: "How artificial intelligence is being used to design optimized peptide blend formulations.", type: "blog" },
  ...
  "n-259-beyond-melatonin": { title: "Beyond Melatonin: Why Your Sleep Protocol is Missing 3 Key Ingredients", desc: "Understanding the multi-pathway approach to sleep: GABA support, neuromuscular relaxation, and alpha-wave promotion.", type: "blog" },
  "n-259-sleep-science": { title: "The Science of Superior Sleep: Deconstructing the N-259 Protocol", desc: "How Apigenin, Magnesium Glycinate, L-Theanine, and physiological melatonin work synergistically for optimal sleep.", type: "blog" },
