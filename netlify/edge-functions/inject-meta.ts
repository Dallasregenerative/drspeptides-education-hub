...
const ROUTE_META: Record<string, RouteMeta> = {
  ...
  '/peptides/bpc-157-arginate-salt': { title: 'BPC-157 Arginate Salt - Stabilized Oral Peptide | Peptide Education Hub', desc: 'Comprehensive guide to BPC-157 Arginate Salt, the stabilized arginine salt form with enhanced oral bioavailability for GI healing and tissue repair.' },
  '/peptides/lions-mane': { title: 'Lions Mane (Hericium erinaceus) - Neurotrophic Mushroom | Peptide Education Hub', desc: 'Evidence-based guide to Lions Mane mushroom for cognitive enhancement, nerve growth factor stimulation, and neuroprotection.' },
  '/peptides/nicotinamide-riboside': { title: 'Nicotinamide Riboside (NR) - NAD+ Precursor | Peptide Education Hub', desc: 'Comprehensive guide to Nicotinamide Riboside for NAD+ biosynthesis, cellular energy, sirtuin activation, and longevity applications.' },
  '/peptides/metformin': { title: 'Metformin - Longevity and Metabolic Optimization | Peptide Education Hub', desc: 'Evidence-based guide to Metformin for anti-aging, AMPK activation, mTOR inhibition, and metabolic optimization beyond diabetes.' },
  // Blends
  ...
  "/peptides/formula-n-259": { title: "Formula N-259: Sleep & Circadian Optimization", desc: "Advanced sleep enhancement formula with L-Theanine, Magnesium, Apigenin, DSIP, AEDG (Epitalon), and Selank for comprehensive circadian rhythm optimization and neuroprotective sleep support.", type: "formula", category: "Sleep" },
  ...
  "/peptides/formula-wl-1175": { title: "Formula WL-6250: Metabolic Health Support", desc: "Advanced metabolic health formula with 6mg Orforglipron and 250mcg SLU-PP-332 for comprehensive weight management and metabolic optimization.", type: "formula", category: "Weight Loss" },
  ...
  "/blends/formula-n-259": { title: "Formula N-259: Sleep & Circadian Optimization", desc: "Advanced sleep enhancement formula with L-Theanine, Magnesium, Apigenin, DSIP, AEDG (Epitalon), and Selank for comprehensive circadian rhythm optimization and neuroprotective sleep support.", type: "formula", category: "Sleep" },
  ...
  "/blends/formula-wl-1175": { title: "Formula WL-6250: Metabolic Health Support", desc: "Advanced metabolic health formula with 6mg Orforglipron and 250mcg SLU-PP-332 for comprehensive weight management and metabolic optimization.", type: "formula", category: "Weight Loss" },
  ...
  "/blog/os-01-organ-protection-liver-kidney-heart": { title: "Beyond Weight Loss: How OS-01 Protects the Liver, Kidneys, and Cardiovascular System", desc: "OS-01 organ protection data: MASLD improvement, kidney aging prevention, cardiovascular support, and abdominal aortic aneurysm prevention.", type: "article" },
  "/blog/os-01-ampk-longevity-exercise-mimetic": { title: "AMPK, Longevity, and the Exercise Mimetic Revolution: The Science Behind OS-01", desc: "How OS-01 connects to the core longevity pathways of exercise, fasting, caloric restriction, and metformin through direct AMPK activation.", type: "article" },
  // M-Shred Blog Articles
  "/blog/m-shred-triple-pathway-fat-loss": { title: "Formula M-Shred: How BAM-15, SLU-PP-332, and C15 Create a Triple-Pathway Fat Loss System", desc: "Deep dive into the synergy of M-Shred's three active compounds: mitochondrial uncoupling, exercise mimetics, and metabolic protection.", type: "article" },
  "/blog/bam15-mitochondrial-uncoupler-science": { title: "BAM-15: The Mitochondrial Uncoupler That Burns Fat Without the Danger of DNP", desc: "How BAM-15 safely increases energy expenditure through targeted mitochondrial uncoupling without the toxicity of DNP.", type: "article" },
  "/blog/slu-pp-332-exercise-mimetic-pill": { title: "SLU-PP-332: The Exercise Mimetic Pill That Makes Your Body Think It's Training for a Marathon", desc: "The science behind the ERR agonist that activates exercise transcriptional programs, increases oxidative muscle fibers, and enhances endurance.", type: "article" },
  "/blog/c15-pentadecanoic-acid-essential-fatty-acid": { title: "C15 (Pentadecanoic Acid): The Newly Discovered Essential Fatty Acid Rewriting Metabolic Medicine", desc: "Why pentadecanoic acid may be the first new essential fatty acid discovered in 90 years, with 3x more cellular benefits than omega-3.", type: "article" },
  // Consent & Regulatory Blog Articles
  "/blog/off-label-vs-unapproved-bpc-157": { title: "Off-Label vs. Unapproved: Why BPC-157 Is NOT an Off-Label Prescription", desc: "The critical legal distinction between off-label use and unapproved drug use, and why it matters for BPC-157 prescribers.", type: "article" },
  "/blog/defensible-peptide-practice-risk-management": { title: "Building a Defensible Peptide Practice: The 5-Point Risk Management Framework", desc: "A structured approach to offering peptide therapy while minimizing regulatory, legal, and malpractice exposure in 2026.", type: "article" },
  "/blog/fda-category-1-vs-category-2-peptides": { title: "FDA Category 1 vs Category 2: Understanding the 503A Bulks List for Peptide Compounding", desc: "What the FDA 503A bulks list categories mean for peptide compounding, which peptides are Category 2, and what practitioners should do.", type: "article" },
  "/blog/malpractice-carrier-peptide-practice": { title: "Why Your Malpractice Carrier Needs to Know About Your Peptide Practice", desc: "A risk management guide for peptide practitioners on malpractice coverage, carrier communication, and protective documentation.", type: "article" },
  // Consent Form Pages
  "/resources/consent-forms": { title: "Peptide Therapy Consent Form Templates - State-Specific & Customizable", desc: "Downloadable, customizable consent form templates for peptide therapy. State-specific forms for TX, CA, FL, NY plus standard US and multi-peptide registry.", type: "page" },
  "/resources/consent-forms/standard-us": { title: "Standard US Peptide Therapy Consent Form Template", desc: "Comprehensive informed consent template for research-grade peptide therapy covering FDA status, risks, alternatives, and patient rights.", type: "page" },
  "/resources/consent-forms/texas": { title: "Texas Peptide Therapy Consent Form - THSC Ch 490 Compliant", desc: "Texas-specific informed consent form for peptide therapy incorporating THSC Chapter 490 Right to Try provisions.", type: "page" },
  "/resources/consent-forms/california": { title: "California Peptide Therapy Consent Form - H&SC §24170 Compliant", desc: "California-specific informed consent form for peptide therapy with experimental subject bill of rights per H&SC §24170.", type: "page" },
  "/resources/consent-forms/florida": { title: "Florida Peptide Therapy Consent Form - §766.103 Compliant", desc: "Florida-specific informed consent form for peptide therapy meeting §766.103 informed consent requirements.", type: "page" },
  "/resources/consent-forms/new-york": { title: "New York Peptide Therapy Consent Form - PHL Art 24-A Compliant", desc: "New York-specific informed consent form for peptide therapy with human research protections per PHL Article 24-A.", type: "page" },
  "/resources/consent-forms/abbreviated": { title: "Abbreviated Peptide Therapy Consent Form - Quick Version", desc: "Shortened informed consent form for peptide therapy covering essential disclosures in a concise format.", type: "page" },
  "/resources/consent-forms/multi-peptide-registry": { title: "Multi-Peptide Protocol with Registry Consent Form", desc: "Comprehensive consent form for multi-peptide protocols with patient registry enrollment for systematic data collection.", type: "page" },
  // GLOW/KLOW products
  ...
  // Additional peptide and page routes
...
"ai-formula-design": { title: "AI-Driven Formula Design: The Future of Peptide Blends", desc: "How artificial intelligence is being used to design optimized peptide blend formulations.", type: "blog" },
  "bam15-mitochondrial-uncoupler-science": { title: "BAM-15: The Mitochondrial Uncoupler That Burns Fat Without the Danger of DNP", desc: "How BAM-15 safely increases energy expenditure through targeted mitochondrial uncoupling.", type: "blog" },
  "bpc157-tb500": { title: "BPC-157 vs TB-500: Comparing Two Powerful Healing Peptides", desc: "Head-to-head comparison of BPC-157 and TB-500 for tissue repair, wound healing, and recovery applications.", type: "blog" },
  "c15-pentadecanoic-acid-essential-fatty-acid": { title: "C15 (Pentadecanoic Acid): The Newly Discovered Essential Fatty Acid Rewriting Metabolic Medicine", desc: "Why pentadecanoic acid may be the first new essential fatty acid discovered in 90 years.", type: "blog" },
  "choosing-supplier": { title: "How to Choose a Peptide Supplier: Quality Standards Guide", desc: "Essential guide for evaluating peptide suppliers including purity testing, COA verification, and regulatory compliance.", type: "blog" },
  "defensible-peptide-practice-risk-management": { title: "Building a Defensible Peptide Practice: The 5-Point Risk Management Framework", desc: "A structured approach to offering peptide therapy while minimizing regulatory and malpractice exposure.", type: "blog" },
  "dr-peptide-ai": { title: "Dr. Peptide AI: Your Intelligent Protocol Assistant", desc: "Introduction to Dr. Peptide AI and how it generates evidence-based peptide therapy protocols.", type: "blog" },
  "fda-category-1-vs-category-2-peptides": { title: "FDA Category 1 vs Category 2: Understanding the 503A Bulks List for Peptides", desc: "What FDA 503A bulks list categories mean for peptide compounding and which peptides are Category 2.", type: "blog" },
  "founder-story": { title: "The Founder Story: Building Peptide Education Hub", desc: "The story behind Peptide Education Hub and the mission to democratize peptide therapy education.", type: "blog" },
  "future-peptide-therapy": { title: "The Future of Peptide Therapy: Emerging Trends", desc: "Emerging trends in peptide therapy including new compounds, delivery methods, and regulatory developments.", type: "blog" },
  "getting-started": { title: "How to Start a Peptide Therapy Practice in 2026", desc: "A comprehensive guide for healthcare providers looking to integrate peptide therapy into their practice.", type: "blog" },
  "ghk-cu": { title: "GHK-Cu: Regenerative Medicine and Skin Rejuvenation", desc: "Clinical guide to GHK-Cu copper peptide for wound healing, skin regeneration, and anti-aging applications.", type: "blog" },
  "glp1-therapy": { title: "Semaglutide vs Tirzepatide: Complete GLP-1 Therapy Guide", desc: "Comprehensive comparison of semaglutide and tirzepatide for weight loss, including dosing protocols and clinical outcomes.", type: "blog" },
  "implementing-peptide-therapy": { title: "Implementing Peptide Therapy in Your Practice", desc: "Step-by-step implementation guide for adding peptide therapy services to your healthcare practice.", type: "blog" },
  "integrating-peptide-therapy-practice": { title: "Integrating Peptide Therapy into Your Practice: A Step-by-Step Implementation Guide", desc: "Practical implementation guide for clinicians on adding peptide therapy services, from legal compliance to patient marketing.", type: "blog" },
  "ipamorelin": { title: "Ipamorelin: Growth Hormone Secretagogue Guide", desc: "Comprehensive ipamorelin guide for GH optimization, anti-aging, and body composition improvement.", type: "blog" },
  "m-2531-cellular-engines": { title: "The Signal and the Fuel: How M-2531 Rejuvenates Cellular Engines", desc: "How MOTS-c, NAD+, and mitochondrial support compounds restore cellular energy production.", type: "blog" },
  "m-2531-exercise-paradox": { title: "The Exercise Paradox: Working Out But Still Feeling Old?", desc: "Why exercise alone is not enough and how mitochondrial peptides can restore youthful energy.", type: "blog" },
  "m-51-nnmt": { title: "The Hidden Enzyme Keeping You Fat: Understanding NNMT", desc: "How NNMT inhibition with 5-Amino-1MQ can unlock stubborn fat loss and improve metabolic health.", type: "blog" },
  "m-51-push-pull": { title: "The Push-Pull Effect: How M-51 Burns Fat from Two Directions", desc: "How 5-Amino-1MQ and SLU-PP-332 work synergistically to inhibit fat storage and activate fat burning.", type: "blog" },
  "m-shred-triple-pathway-fat-loss": { title: "Formula M-Shred: How BAM-15, SLU-PP-332, and C15 Create a Triple-Pathway Fat Loss System", desc: "Deep dive into the synergy of M-Shred's three active compounds for metabolic fat loss.", type: "blog" },
  "malpractice-carrier-peptide-practice": { title: "Why Your Malpractice Carrier Needs to Know About Your Peptide Practice", desc: "Risk management guide for peptide practitioners on malpractice coverage and carrier communication.", type: "blog" },
  "melanotan-ii": { title: "Melanotan II: Photoprotection and Clinical Considerations", desc: "Evidence-based guide to Melanotan II for tanning, photoprotection, and sexual health applications.", type: "blog" },
  "n-111-holy-trinity": { title: "The Holy Trinity of Nootropics: Why N-111 is a Game-Changer", desc: "How J147, Dihexa, and Noopept work together for neurogenesis, memory enhancement, and neuroprotection.", type: "blog" },
  "n-111-neurogenesis": { title: "Are You Building a Better Brain, or Just Renting It?", desc: "Why true cognitive enhancement requires growing new neurons and synapses, not just temporary stimulation.", type: "blog" },
  "n-2331-anxiety-cognition": { title: "The Anxiety-Cognition Connection: Stress and Mental Performance", desc: "How chronic stress impairs cognitive function and the science of restoring mental clarity.", type: "blog" },
  "n-2331-cognitive-stack": { title: "The Ultimate Cognitive Enhancement Stack: Deconstructing N-2331", desc: "How Dihexa, Selank, Semax, and NAD+ work synergistically for comprehensive brain optimization.", type: "blog" },
  "n-259-beyond-melatonin": { title: "Beyond Melatonin: Why Your Sleep Protocol is Missing Key Neuropeptides", desc: "Understanding the multi-pathway approach to sleep: GABAergic modulation, delta-wave induction via DSIP, and neuroprotective support from Epitalon and Selank.", type: "blog" },
  "n-259-sleep-science": { title: "The Science of Superior Sleep: Deconstructing the N-259 Protocol", desc: "How L-Theanine, Magnesium, Apigenin, DSIP, AEDG (Epitalon), and Selank work synergistically for optimal sleep and circadian rhythm restoration.", type: "blog" },
  "n-5550-brain-body": { title: "The Ultimate Brain-Body Upgrade: How N-5550 Tackles Cognition and Metabolism", desc: "Dihexa, Tesofensine, and Methylene Blue for addressing brain fog and metabolic dysfunction together.", type: "blog" },
  "n-5550-brain-fat": { title: "The Brain-Fat Connection: Why Your Weight Loss Stall is All in Your Head", desc: "How dopamine depletion and brain chemistry affect appetite, metabolism, and weight loss resistance.", type: "blog" },
  "n-69-brain-libido": { title: "Is Your Brain the Reason You Are Not in the Mood?", desc: "How stress, dopamine depletion, and hormonal imbalances affect desire, and the science of restoring it.", type: "blog" },
  "n-69-neuroscience-desire": { title: "The Neuroscience of Desire: How N-69 Reboots the Brain-Body Connection", desc: "A deep dive into the 5-pathway approach of NALT, Kisspeptin, PT-141, Oxytocin, and VIP for sexual wellness.", type: "blog" },
  "neuro-series-formulas": { title: "Neuro Series Formulas: Advanced Cognitive Peptide Blends", desc: "Overview of the N-series cognitive enhancement formulas including N-69, N-111, N-259, N-2331, and N-5550.", type: "blog" },
  "off-label-vs-unapproved-bpc-157": { title: "Off-Label vs. Unapproved: Why BPC-157 Is NOT an Off-Label Prescription", desc: "The critical legal distinction between off-label use and unapproved drug use for BPC-157 prescribers.", type: "blog" },
  "os-01-ampk-longevity-exercise-mimetic": { title: "AMPK, Longevity, and the Exercise Mimetic Revolution: The Science Behind OS-01", desc: "How OS-01 connects to the core longevity pathways of exercise, fasting, and caloric restriction.", type: "blog" },
  "os-01-first-oral-ampk-activator": { title: "OS-01 (ATX-304): The First Oral Pan-AMPK Activator That Burns Fat While Protecting Muscle", desc: "Deep dive into OS-01's dual AMPK activation and mitochondrial uncoupling mechanism for fat-focused weight loss with muscle preservation.", type: "blog" },
  "os-01-missing-half-glp1-therapy": { title: "Why OS-01 May Be the Missing Half of GLP-1 Therapy: ENDO 2025 Breakthrough Data", desc: "ENDO 2025 data shows ATX-304 combined with semaglutide prevents muscle loss and weight regain.", type: "blog" },
  "os-01-organ-protection-liver-kidney-heart": { title: "Beyond Weight Loss: How OS-01 Protects the Liver, Kidneys, and Cardiovascular System", desc: "OS-01 organ protection data: MASLD improvement, kidney aging prevention, cardiovascular support.", type: "blog" },
  "peptide-practice-business": { title: "Building a Peptide Therapy Business: Practice Guide", desc: "Business strategies for building and growing a successful peptide therapy practice.", type: "blog" },
  "peptide-therapy-billing-coding": { title: "Peptide Therapy Billing & Coding: A Clinician's Guide to Reimbursement", desc: "Comprehensive guide for healthcare providers on navigating CPT codes, J-codes, and billing strategies for peptide therapy reimbursement.", type: "blog" },
  "peptideprotocols-ai": { title: "PeptideProtocols.AI: How AI is Revolutionizing Peptide Therapy", desc: "How Dr. Peptide AI uses 16 specialized agents to generate personalized peptide protocols from clinical data.", type: "blog" },
  "peptides-immune-support": { title: "Peptides for Immune Support: Clinical Applications", desc: "Evidence-based guide to immune-modulating peptides including thymosin alpha-1, LL-37, and KPV.", type: "blog" },
  "peptides-sexual-health": { title: "Peptides for Sexual Health: PT-141 and Beyond", desc: "Clinical guide to peptides for sexual health including PT-141, kisspeptin, and oxytocin protocols.", type: "blog" },
  "peptides-sleep-optimization": { title: "Peptides for Sleep Optimization: DSIP and Beyond", desc: "Guide to sleep-optimizing peptides including DSIP, pinealon, and the N-259 sleep protocol.", type: "blog" },
  "practice-roi": { title: "Peptide Therapy ROI: Building a Profitable Practice", desc: "Financial analysis and business strategies for building a profitable peptide therapy practice.", type: "blog" },
  "pt-141": { title: "PT-141 (Bremelanotide): Sexual Wellness Applications", desc: "Clinical guide to PT-141 for sexual dysfunction in men and women, including dosing and patient selection.", type: "blog" },
  "quality-standards": { title: "Peptide Quality Standards: What Healthcare Providers Need to Know", desc: "Understanding peptide purity, potency, and quality testing standards for clinical applications.", type: "blog" },
  "regen-metabolic-formulas": { title: "Regenerative and Metabolic Formulas: Advanced Peptide Blends", desc: "Overview of regenerative and metabolic peptide formulas including RG-5555, M-51, M-2531, and W-1175.", type: "blog" },
  "rg-5555-gut-healing": { title: "Is Your Gut Sabotaging Your Injury Recovery?", desc: "How gut permeability affects systemic inflammation and the role of Larazotide in healing.", type: "blog" },
  "rg-5555-healing-cascade": { title: "The 4-Step Cascade of Superior Healing: Deconstructing RG-5555", desc: "How BPC-157, TB-500, KPV, and Larazotide work together for comprehensive injury recovery.", type: "blog" },
  "retatrutide-phase-3-results": { title: "Retatrutide Phase 3 Results: Is This the Last GLP-1 Drug We Will Ever Need? | Peptide Education Hub", desc: "Analysis of retatrutide Phase 3 TRANSCEND-T2D-1 data showing 28.7% weight loss, triple receptor mechanism, lean mass concerns, and the new dysesthesia safety signal.", type: "blog" },
  "semaglutide-bpc157-case-study": { title: "Advanced Case Study: Combining Semaglutide and BPC-157 for Optimized Weight Loss and Gut Health", desc: "Clinical case study exploring synergistic effects of Semaglutide and BPC-157 combination therapy for weight loss and GI health.", type: "blog" },
  "semax": { title: "Semax: Cognitive Enhancement and Neuroprotection", desc: "Comprehensive guide to semax for cognitive enhancement, stroke recovery, and neuroprotective applications.", type: "blog" },
  "slu-pp-332-exercise-mimetic-pill": { title: "SLU-PP-332: The Exercise Mimetic Pill That Makes Your Body Think It's Training for a Marathon", desc: "The science behind the ERR agonist that activates exercise transcriptional programs.", type: "blog" },
  "storage-handling": { title: "Peptide Storage and Handling: Best Practices Guide", desc: "Complete guide to proper peptide storage, handling, reconstitution, and stability for healthcare practices.", type: "blog" },
  "tesamorelin": { title: "Tesamorelin: Visceral Fat Reduction and GH Optimization", desc: "Clinical guide to tesamorelin for visceral fat reduction, lipodystrophy, and growth hormone optimization.", type: "blog" },
  "thymosin-alpha-1": { title: "Thymosin Alpha-1: Immune Modulation for Clinical Practice", desc: "Evidence-based guide to thymosin alpha-1 for immune support, cancer adjunct therapy, and chronic infections.", type: "blog" },
  "training-practitioners": { title: "Training Practitioners in Peptide Therapy", desc: "Guide to peptide therapy training programs, certifications, and continuing education for healthcare providers.", type: "blog" },
  "w-1175-exercise-pill": { title: "The Exercise in a Pill Phenomenon: Deconstructing W-1175", desc: "How SLU-PP-332 and Orforglipron combine exercise mimetics with GLP-1 for metabolic optimization.", type: "blog" },
};
